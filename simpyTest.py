...
#Descripción del funcionamiento del programa: Este programa realiza una simulación de un sistema operativo, con RAM y número de CPUs 
...
#En este apartado se hacen las pruebas correspondientes para poder realizar las graficas 
...
# Generador de procesos: esta funcion genera el proceso requerido para las pruebas que se solicitan 
...
#La informacion de los procesos que se han realizado para la creacion de las graficas 
